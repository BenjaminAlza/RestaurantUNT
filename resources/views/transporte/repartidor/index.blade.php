...
<h3>LISTADO REPARTIDORES</h3>

<!-- Botón Nuevo -->
<a href="{{route('repartidor.create')}}" class="btn btn-warning"><i class="fas fa-plus"></i> Nuevo Repartidor</a>
    ...
    <tbody>
      ...
      @else
        ...
        <tr class="text-center">
         ...
         <td>
             <a href="{{route('repartidor.edit',$itemrepartidor->idRepartidor)}}" class="btn btn-info btn-sm"><i class="fas fa-edit"></i>Editar</a>
            <a href="{{route('repartidor.confirmar',$itemrepartidor->idRepartidor)}}" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i>Eliminar</a>
         </td>
        </tr>
